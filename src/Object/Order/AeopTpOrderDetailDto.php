...
class AeopTpOrderDetailDto
{
	...
	/** 
	 * 商品信息
     * @var AeopTpOrderProductInfoDto|null
	 **/
	public $child_order_ext_info_list;
	
	/** 
	 * 子订单列表
     * @var AeopTpChildOrderDto|null
	 **/
	...
	/** 
	 * 物流信息
     * @var AeopTpLogisticInfoDto|null
	 **/
	...
	/** 
	 * 操作日志列表
     * @var AeopTpOperationLogDto|null
	 **/
	...
	/** 
	 * 收货地址信息
     * @var AeopTpAddressDto
	 **/
	public $receipt_address;
	
	/** 
	 * 退款信息
     * @var AeopTpRefundInfoDto
	 **/
	public $refund_info;
